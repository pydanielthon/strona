...
gulp.task('concat:js', () => {
  return gulp.src([
      ...
      '!' + path.src_js_vendor + '/chartist.min.js',
...
gulp.task(
  'default',
  gulp.series('clean', gulp.parallel('concat:js', 'move:js', 'concat:css', 'move:css', 'uglify:js', 'pug', 'sass:minified', 'sass:expanded'), 'watch')
);
